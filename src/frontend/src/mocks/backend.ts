...
export const mockBackend: backendInterface = {
  ...
  generateOtp: async () => ({ __kind__: "ok" as const, ok: { code: "123456" } }),
  verifyOtp: async () => ({ __kind__: "ok" as const, ok: null }),
  ...
  createStudyMaterial: async () => ({
    ...
    ok: {
      ...
      uploadedBy: { toText: () => "2vxsx-fae" } as any,
    },
  }),
  deleteStudyMaterial: async () => true,
  getStudyMaterial: async () => null,
  getStudyMaterialDownloadStats: async () => [],
  listAllStudyMaterials: async () => [],
  listStudyMaterials: async () => [],
  recordStudyMaterialDownload: async () => undefined,
  updateStudyMaterialMetadata: async () => ({
    __kind__: "ok" as const,
    ok: {
      id: "sm-mock-1",
      semester: BigInt(3),
