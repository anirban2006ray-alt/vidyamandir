...
export type OtpResult = { 'ok' : { 'code' : string } } |
  { 'err' : string };
export type OtpVerifyResult = { 'ok' : null } |
  {
    'err' : { 'expired' : null } |
...
export interface _SERVICE {
  ...
  'createReview' : ActorMethod<
    ...
    { 'ok' : ReviewId } |
      { 'err' : AppError }
  >,
  'createStudyMaterial' : ActorMethod<
  ...
  'deleteStudyMaterial' : ActorMethod<[string], boolean>,
  'downloadInvoice' : ActorMethod<[OrderId], string>,
  'generateOtp' : ActorMethod<[], OtpResult>,
  ...
  'getStudyMaterialDownloadStats' : ActorMethod<[], Array<[string, bigint]>>,
  ...
  'listReviewsSorted' : ActorMethod<
    ...
    Array<Review>
  >,
  'listStudyMaterials' : ActorMethod<
    [[] | [StudyMaterialFilter]],
    Array<StudyMaterial>
  >,
  ...
  'recordStudyMaterialDownload' : ActorMethod<[string], undefined>,
  ...
  'updateStudyMaterialMetadata' : ActorMethod<
    [string, UpdateStudyMaterialMetadataInput],
    { 'ok' : StudyMaterial } |
      { 'err' : AppError }
  >,
  'validatePromoCode' : ActorMethod<[string], [] | [PromoCode]>,
  'verifyOtp' : ActorMethod<[string], OtpVerifyResult>,
