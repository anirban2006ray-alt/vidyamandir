import { g as createLucideIcon, A as useParams, d as useNavigate, u as useLanguage, C as useAuth, v as useCart, D as useGetProduct, w as useGetWishlist, E as useListReviews, F as useListQuestions, J as useRecordRecentlyViewed, K as useAddToWishlist, M as useRemoveFromWishlist, N as useVoteReviewHelpful, r as reactExports, j as jsxRuntimeExports, B as Button, s as Badge, x as formatPrice, O as ue, z as ShoppingCart, H as Heart, Q as useCreateReview, t as Label, I as Input, T as Textarea, R as useAskQuestion, U as useListAnswers, V as usePostAnswer, W as useVoteAnswerHelpful, Y as MessageCircle, Z as getErrorMessage } from "./index-CCJ-y6hm.js";
import { S as Separator } from "./separator-DAmw2xOp.js";
import { S as Skeleton } from "./skeleton-CD2Ss7Io.js";
import { B as BookCover } from "./BookCover-CsJVU9GC.js";
import { S as StarRating } from "./StarRating-BRDfg336.js";
import { B as BookOpen } from "./book-open-CB1Iz7KX.js";
import { C as ChevronRight } from "./chevron-right-B9O8mBv_.js";
import { m as motion } from "./proxy-DBAVeBfS.js";
import { C as CircleCheck } from "./circle-check-CuMIVHSC.js";
import { T as Truck } from "./truck-CNmNqCWy.js";
import { M as Minus } from "./minus-D51y1sVX.js";
...
import { A as AnimatePresence } from "./index-BPsYzzIn.js";
import { C as ChevronLeft } from "./chevron-left-BPh1Ext1.js";
/**
...
function ImageCarousel({
  ...
  const coverSrc = resolvedImages.length > 0 ? resolvedImages : isbn ? [`https://covers.openlibrary.org/b/isbn/${isbn}-L.jpg`] : [];
  const displayImages = coverSrc.length > 0 ? coverSrc : [null];
  const goTo = (idx) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-24 space-y-3", "data-ocid": "product.image_carousel", children: [
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: displayImages[active] ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                BookCover,
                {
    ...
    displayImages.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto pb-1 max-w-[380px] mx-auto md:mx-0 scroll-smooth", children: displayImages.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: `shrink-0 w-14 h-18 rounded-md overflow-hidden border-2 transition-smooth relative ${i === active ? "border-accent shadow-card" : "border-border opacity-60 hover:opacity-100 hover:border-accent/50"}`,
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(BookCover, { coverImageUrl: null, isbn, title })
      },
      `thumb-pos-${i + 1}`
    )) })
  ] });
      ...
      },
      {
        onSuccess: (result) => {
          if (result.__kind__ === "ok") {
            ...
            ue.error(getErrorMessage(result.err));
          }
        },
        onError: (err) => {
          const msg = err && typeof err === "object" && "__kind__" in err ? getErrorMessage(err) : "Failed to submit review. Please try again.";
          ue.error(msg);
        }
      }
    );
