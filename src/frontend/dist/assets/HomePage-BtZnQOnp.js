import { r as reactExports, u as useLanguage, a as useListProducts, S as SortOrder, b as SortField, L as Language, c as useListFlashSales, j as jsxRuntimeExports, d as useNavigate, G as Genre, e as Link, P as ProductCardSkeleton, f as useGetRecentlyViewed } from "./index-Bz7t5j9k.js";
import { P as ProductCard } from "./ProductCard-zZeiwC_O.js";
import { r as resolveElements, m as motion } from "./proxy-CuVWi4zi.js";
import "./BookCover-CAnA17qx.js";
import "./StarRating-BnePZ34y.js";
import "./star-CbAZk3SB.js";
import "./zap-8lYqkyod.js";
const thresholds = {
  some: 0,
  all: 1
};
...
function BookOfferSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, oklch(0.11 0.07 258) 0%, oklch(0.14 0.09 255) 55%, oklch(0.12 0.08 260) 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute right-0 top-0 bottom-0 w-2/3 pointer-events-none",
            style: {
              background: "radial-gradient(ellipse at 85% center, oklch(0.62 0.27 40 / 0.13), transparent 65%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-screen-xl mx-auto px-4 py-10 md:py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 relative flex items-center justify-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "radial-gradient(ellipse at center, oklch(0.62 0.27 40 / 0.18), transparent 65%)",
                      filter: "blur(12px)"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      background: "linear-gradient(135deg, oklch(0.13 0.09 258), oklch(0.18 0.10 255))"
                    },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          style: {
                            ...
                            background: "linear-gradient(180deg, oklch(0.58 0.27 38), oklch(0.50 0.25 35))",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          style: {
                            ...
                            background: "linear-gradient(160deg, oklch(0.16 0.10 258), oklch(0.12 0.08 255))",
                            overflow: "hidden"
                          },
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                style: {
                                  height: 4,
                                  background: "linear-gradient(90deg, oklch(0.62 0.27 40), oklch(0.55 0.25 38))"
                                }
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "svg",
                              {
                                width: "60",
                                height: "44",
                                ...
                                children: [
                                  ...
                                  [10, 16, 22, 28].map((y) => /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "line",
                                      {
                                        x1: "6",
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 mt-2 text-center", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "p",
                                {
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                style: {
                                  height: 4,
                                  background: "linear-gradient(90deg, oklch(0.55 0.25 38), oklch(0.62 0.27 40))"
                                }
                              }
                            )
                          ]
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          style: {
                            width: 6,
                            background: "repeating-linear-gradient(to bottom, oklch(0.90 0 0 / 0.6), oklch(0.90 0 0 / 0.6) 1px, oklch(0.80 0 0 / 0.2) 1px, oklch(0.80 0 0 / 0.2) 3px)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center md:items-start gap-5 text-center md:text-left max-w-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(0.60 0.27 38), oklch(0.53 0.25 35))",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: lang === "bn" ? "এই মৌসুমে বাছাই করা বইয়ে" : "Select Books This Season"
                        }
                      )
                    ]
                  }
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "h2",
                        {
                          ...
                          children: lang === "bn" ? "সেরা বইয়ে সেরা ছাড়" : "Big Discounts on Great Books"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: lang === "bn" ? "পূর্ব বর্ধমানের সেরা বইয়ের দোকান — বিদ্যামন্দির" : "Purba Bardhaman's favourite bookshop — Vidyamandir"
                        }
                      )
                    ]
                  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(BookOfferSection, {}),
