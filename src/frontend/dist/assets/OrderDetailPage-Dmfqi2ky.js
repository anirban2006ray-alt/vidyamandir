import { d as createLucideIcon, j as jsxRuntimeExports, r as reactExports, e as useComposedRefs, f as cn, t as buttonVariants, n as useParams, u as useLanguage, o as useAuth, c as Link, q as LoadingSpinner, B as Button, l as formatPrice, M as MapPin, p as ue } from "./index-CokRMBGk.js";
import { c as composeEventHandlers, b as createSlottable, a as createContextScope } from "./index-Cy9ZU6j8.js";
import { R as Root, T as Trigger, W as WarningProvider, C as Content, a as Title, D as Description, b as Close, c as createDialogScope, P as Portal, O as Overlay } from "./index-CQ24ArX6.js";
import { S as Separator } from "./separator-DBCWdMsU.js";
import { v as useGetOrder, w as useDownloadInvoice, x as useCancelOrder, y as useUpdateOrderStatus } from "./useQueries-Blrj1_w6.js";
import { P as Package } from "./package-DiLR1Jod.js";
import { m as motion } from "./proxy-_JMx5lOw.js";
import { C as Clock } from "./clock-BGqFKgVm.js";
import { T as Truck } from "./truck-BkroCBso.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/20 min-h-screen", "data-ocid": "order_detail.page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-6 sm:py-10 space-y-4", children: [
    ...
    isActiveOrder && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground mb-6", children: lang === "bn" ? "ডেলিভারি স্ট্যাটাস" : "Delivery Status" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 left-4 right-4 h-0.5 bg-border" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "absolute top-4 left-4 h-0.5 bg-accent transition-all duration-700",
                style: {
                  width: currentStepIdx < 0 ? "0%" : `${currentStepIdx / (TIMELINE.length - 1) * 100}%`
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex justify-between", children: TIMELINE.map((step, i) => {
              const done = i < currentStepIdx;
              const active = i === currentStepIdx;
              const StepIcon = done ? CircleCheck : active ? step.icon : Circle;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `w-8 h-8 rounded-full flex items-center justify-center z-10 transition-all duration-300 ${done ? "bg-accent text-accent-foreground shadow-elevated" : active ? "bg-accent text-accent-foreground ring-4 ring-accent/25 shadow-elevated" : "bg-card border-2 border-border text-muted-foreground"}`,
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(StepIcon, { size: 16 })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: `text-xs font-semibold ${active ? "text-accent" : done ? "text-foreground" : "text-muted-foreground"}`,
                          children: lang === "bn" ? step.bn : step.en
                        }
                      ),
                      active && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-accent/70 mt-0.5", children: lang === "bn" ? "বর্তমান" : "Current" })
                    ] })
                  ]
                },
                step.status
